...
const colorProperties = [
  ...
  { key: 'cardBackgroundMobile', label: 'Card Background (Mobile)', description: 'Background for cards on mobile' },
  { key: 'cardTextColorMobile', label: 'Card Text Color (Mobile)', description: 'Text color for cards on mobile' },
  { key: 'cardHeadingColorMobile', label: 'Card Heading Color (Mobile)', description: 'Heading color for cards on mobile' },
  { key: 'cardBorderColor', label: 'Card Border', description: 'Border color for cards' },
  { key: 'pointsBackground', label: 'Points Background', description: 'Background for points/features section' },
  { key: 'pointsBorderColor', label: 'Points Border', description: 'Border color for points section' },
  { key: 'pointsTextColor', label: 'Points Text Color', description: 'Text color for points section' },
  { key: 'lastPointHighlight', label: 'Last Point Highlight', description: 'Highlight color for last point' },
...
const sectionColorMapping = {
  ...
  problem: ['backgroundColor', 'headingColor', 'textColor', 'accentColor', 'highlightColor', 'cardBackground', 'cardBackgroundMobile', 'cardTextColorMobile', 'cardHeadingColorMobile', 'cardBorderColor'],
  solution: ['backgroundColor', 'headingColor', 'textColor', 'iconColor', 'cardBackground', 'pointsBackground', 'pointsBorderColor', 'pointsTextColor', 'lastPointHighlight'],
