    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.user.role === 'super_admin') {
          navigate('/workspace/super-admin');
        } else {
  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <h1 style={styles.title}>Workspace Login</h1>
        <p style={styles.subtitle}>Sign in to manage your projects</p>
        ...
        <div style={styles.footer}>
          <p style={styles.footerText}>It's Goti Workspace System</p>
        </div>
      </div>
    </div>
  );
